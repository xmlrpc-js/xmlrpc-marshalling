 ...
 */
var DateFormatter = module.exports = function (opts) {
  this.opts = {}
  this.setOpts(opts)
};

// declare variable that caches the single instance
var __instance

/**
 * Return the cached DateFormatter instance
 * @return {DateFormatter}
 */
DateFormatter.getInstance = function () {
  return __instance
}
...
// make sure we always create an instance of DateFormatter
__instance = new DateFormatter()
