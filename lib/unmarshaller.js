...
var Unmarshaller = function(encoding) {
  this.type = null
...
Unmarshaller.prototype.unmarshalMethodResponse = function(stream, callback) {
  var that = this
...
Unmarshaller.prototype.unmarshalMethodCall = function(stream, callback) {
  var that = this
...
Unmarshaller.prototype.onDone = function() {
  var that = this
...
Unmarshaller.prototype.onError = function(msg) {
  if (!this.error) {
...
Unmarshaller.prototype.push = function(value) {
...
Unmarshaller.prototype.onOpentag = function(node) {
...
Unmarshaller.prototype.onText = function(text) {
  this.data.push(text)
}

Unmarshaller.prototype.onCDATA = function(cdata) {
  this.data.push(cdata)
}

Unmarshaller.prototype.onClosetag = function(el) {
...
Unmarshaller.prototype.endNil = function(data) {
  this.push(null)
  this.value = false
}

Unmarshaller.prototype.endBoolean = function(data) {
  if (data === '1') {
    this.push(true)
  }
  else if (data === '0') {
...
Unmarshaller.prototype.endInt = function(data) {
...
Unmarshaller.prototype.endDouble = function(data) {
...
Unmarshaller.prototype.endString = function(data) {
  this.push(data)
  this.value = false
}

Unmarshaller.prototype.endArray = function(data) {
  var mark = this.marks.pop()
  this.stack.splice(mark, this.stack.length - mark, this.stack.slice(mark))
  this.value = false
}

Unmarshaller.prototype.endStruct = function(data) {
  var mark = this.marks.pop()
    , struct = {}
...
Unmarshaller.prototype.endBase64 = function(data) {
  var buffer = new Buffer(data, 'base64')
  this.push(buffer)
  this.value = false
}

Unmarshaller.prototype.endDateTime = function(data) {
...
var isInteger = /^-?\d+$/
Unmarshaller.prototype.endI8 = function(data) {
...
Unmarshaller.prototype.endValue = function(data) {
  if (this.value) {
    this.endString(data)
  }
}

Unmarshaller.prototype.endParams = function(data) {
  this.responseType = 'params'
}

Unmarshaller.prototype.endFault = function(data) {
  this.responseType = 'fault'
}

Unmarshaller.prototype.endMethodResponse = function(data) {
  this.type = 'methodresponse'
}

Unmarshaller.prototype.endMethodName = function(data) {
  this.methodname = data
}

Unmarshaller.prototype.endMethodCall = function(data) {
